                 ...
                 return (
                    <button
                        ...
                        className={`group relative flex items-center justify-center w-full aspect-square rounded-2xl transition-all duration-300 ${
                            isActive 
                            ? 'bg-primary-100 dark:bg-white/10 text-primary-600 dark:text-white shadow-inner border border-primary-300 dark:border-white/10' 
            ...
            {SYSTEM_MODULES.map((item) => {
                 ...
                 return (
                    <button
                        ...
                        className={`group relative flex items-center justify-center w-full aspect-square rounded-2xl transition-all duration-300 ${
                            isActive 
                            ? 'bg-primary-100 dark:bg-white/10 text-primary-600 dark:text-white border border-primary-300 dark:border-white/10' 
                            : 'text-neutral-600 dark:text-neutral-500 hover:text-primary-600 dark:hover:text-white hover:bg-primary-50 dark:hover:bg-white/5'
                        }`}
                        title={item.label}
                    >
